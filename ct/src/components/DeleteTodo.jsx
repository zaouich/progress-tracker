...
const DeleteTodo = (props)=>{
    ...
    const handleSubmit = (e)=>{
        e.preventDefault()
        axios.delete(`http://127.0.0.1:3000/api/v1/projects/${projectId}/todos/${todoId}`,{withCredentials: true, data : {password}}
        ).then(()=>{
    ...
    <div className="container">
        <div className="row mb-5">
            <div className="col-md-8 col-xl-6 text-center mx-auto">
                <h2>Delete todo</h2>
                <p className="w-lg-50">are you sure you want to delete the todo ?</p>
            </div>
        </div>
                ...
                <div className="card mb-5">
                    <div className="card-body d-flex flex-column align-items-center">
                        ...
                        className="text-center" method="post">
                            ...
                            <div className="mb-3"><input className="form-control" type="password" name="password" placeholder="Account's Password" 
                            onChange={
                                (e)=>{
